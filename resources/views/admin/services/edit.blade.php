                    ...
                    <div class="row mt-5">
                        <div class="col-12">
                            <div class="card p-4"> <!-- Added padding inside the card -->
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <form class="forms-sample" enctype="multipart/form-data" method="POST" action="{{ route('services.update',$services->id) }}">
                                            @csrf
                                            @method('PUT')
                                            <div class="row">
                                                 <!-- Added margin bottom to the form groups -->
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                          <label>Image</label>
                                                          <img src="{{$services->imageicons}}" height="100px" width="100px">
                                                ...
                                                <div class="col-md-6 mb-3"> <!-- Added margin bottom to the form groups -->
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="details" name="details" value="{{$services->details}}">
                                                        @error('speakers')
                                                        <div class="invalid-feedback d-block">
                                                            {{ $message }}
                                                        </div>
                                                ...
                                                <div class="col-md-6 mb-3"> <!-- Added margin bottom to the form groups -->
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="services" name="services" value="{{$services->services}}">
                                                        @error('speakers')
                                                        <div class="invalid-feedback d-block">
                                                            {{ $message }}
                                                        </div>
                                                ...
                                                <div class="col-md-6 mb-3"> <!-- Added margin bottom to the form groups -->
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="details2" name="details2"  value="{{$services->details2}}">
                                                        @error('speakers')
                                                        <div class="invalid-feedback d-block">
                                                            {{ $message }}
                                                        </div>
                                                ...
                                                <div class="col-md-6 mb-3"> <!-- Added margin bottom to the form groups -->
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="price" name="price"  value="{{$services->price}}">
                                                        @error('speakers')
                                                        <div class="invalid-feedback d-block">
                                                            {{ $message }}
                                                        </div>
